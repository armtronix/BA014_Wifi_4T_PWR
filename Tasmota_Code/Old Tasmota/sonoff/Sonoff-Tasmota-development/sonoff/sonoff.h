...
const uint8_t MAX_SWITCHES = 4;             // Max number of switches                             last edited:Kiran may23
const uint8_t MAX_RELAYS = 4;               // Max number of relays                               last edited:Kiran may23
const uint8_t MAX_INTERLOCKS = 2;           // Max number of interlock groups (MAX_RELAYS / 2)    last edited:Kiran may23
