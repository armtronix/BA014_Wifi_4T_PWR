...
void loop() 
{
   ...
   if (int_regulator >=1001)
   {
    data = 99;//  x* (99/1024)  x is adc data
   // Serial.println(data);
   }
   else if (int_regulator >=801)// || (int)int_regulator <1000)
   {
    data =80; //  x* (99/1024)  x is adc data
    //Serial.println(data);
   }
   else if (int_regulator >=601)//|| (int)int_regulator <800)
   {
    data = 60; //  x* (99/1024)  x is adc data
   // Serial.println(data);
   }
   else if (int_regulator >=401)// || (int)int_regulator <600)
   {
    data = 50;//  x* (99/1024)  x is adc data
   // Serial.println(data);
   }
   else if (int_regulator >=201)//|| (int)int_regulator <400)
   {
    data = 40;//  x* (99/1024)  x is adc data
   // Serial.println(data);
   }
   else if (int_regulator >=101)//|| (int)int_regulator <200)
   {
    data = 20;//  x* (99/1024)  x is adc data
   // Serial.println(data);
   }
   else if (int_regulator >=51)//|| (int)int_regulator <100)
   {
    data = 10;//  x* (99/1024)  x is adc data
   // Serial.println(data);
   }
   else if (int_regulator <50)
   {
