...
<div class="bulb bulbOn"></div>
<div class="bulb bulbOff"></div>
<input id="ch4" type="range" min="0" max="100" value="0" class="slider" onchange="updateSlider(this)">
</div>
<div class="slidecontainer" style="text-align: center">
<a href="#" class="buttonOff" onClick="setCh1(0)"> Off </a> <a href="#" onClick="setCh1(50)"> 50% </a> <a href="#" class="buttonOn"  onClick="setCh1(99)"> 100% </a>
</div>
<div class="slidecontainer" style="text-align: center">
<a href="#" class="buttonOn"  id='runtime2' onClick="setCh2(100)"></a> <a href="#" class="buttonOn"  id='runtime3' onClick="setCh3(100)"></a> <a href="#" class="buttonOn" id='runtime4' onClick="setCh4(100)"></a>
</div>
<div class="slidecontainer" style="text-align: center">
...
//              else if(dum3.substring(4).toInt()==0)
...
//              else if(dum4.substring(4).toInt()==0)
